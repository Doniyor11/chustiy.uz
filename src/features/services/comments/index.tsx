      ...
      >
        <Carousel.Slide>
          <div className={s.card}>
            ...
            <Text className={s.description}>
              "Ijtimoiy tarmoqlar orqali juda ham ko'p do'st ortirganman, shu
              qatorda Bahriddin Chustiy bilan ham birinchi online tanishganmiz,
              yozgan postlari va fikrlari bilan juda ham katta qiziqish
              uyg'otgan va Bahriddin akani kuzatishni boshlaganman"
            </Text>
        ...
        <Carousel.Slide>
          <div className={s.card}>
            <IconQuotes />
            <Text className={s.description}>
              "Bu insonni ijtomoiy tarmoqlarda ko'rib uni san'ati umuman o'zbek
              milliy taomlariga yondashuvini ko'rib qiziqish bildirib yurgan
              edim, keyin esa Bahriddin ochgan restoranlardan biriga Chustiy
              cuisine, keyin Sal-Sal ga borib haqiqatdan bu bolani mehri umuman
              san'atiga nisbatdan yondashuvi o'zgachaligini ko'rdim
            </Text>
            <div className={s.cardBottom}>
              <Box className={s.cardBottomImg}>
                <Image
        ...
        <Carousel.Slide>
          <div className={s.card}>
            <IconQuotes />
            <Text className={s.description}>
              "Bahriddin ser g'ayrat va tadbirkorlik qobiliyatiga ham ega inson.
              O'zbekistonda yangi uslubda ishlayotgn oshxonalarni ochib
              yoshlarga o'rnak bo'lib kelmoqda. O'zbek taomlari haqida internet
              tarmoqlarda ajoyib qilib so'zlamoqda"
            </Text>
            <div className={s.cardBottom}>
              <Box className={s.cardBottomImg}>
                <Image
