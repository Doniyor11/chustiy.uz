    ...
    <div className={cx(s.sectionWrapper, "container")}>
      <div className={s.sectionLeft}>
        ...
        <Text className={"section-subtitle"}>
          Biz sizga har bir bosqichda yordam berishga tayyormiz. Mahsulotlarimiz
          haqida savolingiz bo‘lsa, xizmatlarimizga bog‘liq yordam kerak bo‘lsa
          yoki fikr-mulohazangizni bildirmoqchi bo‘lsangiz - sizdan eshitishdan
          mamnun bo‘lamiz!
        </Text>
        ...
        <Flex className={s.socials} align={"center"} gap={20}>
          ...
          <Link
            href={"https://www.instagram.com/chustiy.uz?igsh=ZTBpdmZmZnZ6bTEx"}
          >
            <IconInstagram />
          </Link>
