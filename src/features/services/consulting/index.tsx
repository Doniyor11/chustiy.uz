      ...
      <div className={s.box}>
        ...
        <Box>
          ...
          <Text className={"section-subtitle"}>
            Biz xalqaro miqyosda faoliyat yuritayotgan professional restoran
            consulting kompaniyasimiz. Hozirga qadar 7 ta muvaffaqiyatli
            restoran loyihasini yaratganmiz: Oshxona.uz, Sal Sal, Chustiy
            Cousiniy, Aksu, Kebab and Rice va Afsona.family, Parvarda. Har bir
            loyiha o‘ziga xos konsept, ta’m va dizayni bilan mehmonlar mehrini
            qozongan va bozorda muvaffaqiyatli faoliyat yuritmoqda.Bizning
